...
router.put('/', [check('id_activo', 'El id activo es obligatorio').not().isEmpty(), check('id_persona', 'El id empleado es obligatorio').not().isEmpty(), authJwt.verifyToken, authJwt.isSuperAdminOrAdmin], activoController.asignarActivo);
