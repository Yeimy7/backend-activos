...
const router = Router();
import * as pisoController from '../controllers/piso.controller.js'; // import { authJwt } from '../middlewares'

import * as authJwt from '../middlewares/authJwt.js';
import { check } from 'express-validator';
router.post('/', [check('codigo_piso', 'El código del piso es obligatorio').not().isEmpty(), check('id_edificio', 'El id del edificio es obligatorio').not().isEmpty(), authJwt.verifyToken, authJwt.isSuperAdminOrAdmin], pisoController.crearPiso);
