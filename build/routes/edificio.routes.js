...
const router = Router();
import * as edificioController from '../controllers/edificio.controller.js'; // import { authJwt } from '../middlewares'

import * as authJwt from '../middlewares/authJwt.js';
import { check } from 'express-validator';
router.post('/', [check('nombre_edificio', 'El nombre del edificio es obligatorio').not().isEmpty(), authJwt.verifyToken, authJwt.isSuperAdminOrAdmin], edificioController.crearEdificio);
