...
router.post('/', [check('nombre_area', 'El nombre de área es obligatorio').not().isEmpty(), check('codigo_area', 'El código de área es obligatorio').not().isEmpty(), authJwt.verifyToken, authJwt.isSuperAdminOrAdmin], areaController.crearArea);
