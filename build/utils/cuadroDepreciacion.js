...
export const depreciacion = async (fecha_ingreso, mesActual, anioActual, vida_util, costo, valorResidual, ufvAnterior, ufvActual) => {
  ...
  const B = mesesUsados > vUtil ? 0 : vUtil - mesesUsados; // const B = await vUtil - mesesUsados;
